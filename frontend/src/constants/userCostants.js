export const USER_SIGNIN_REQUEST = 'USER_REGISTER_REQUEST';
export const USER_SIGNIN_SUCCESS = 'USER_REGISTER_SUCCESS';
export const USER_SIGNIN_FAIL = 'USER_REGISTER_FAIL';
